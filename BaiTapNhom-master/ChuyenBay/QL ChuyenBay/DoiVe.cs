    ...
    public partial class DoiVe : Form
    {
        ...
        public List<Ve> GetEmployee()
        {
            ...
            try
            {
                ...
                string MaVe, MaHK, MaCB, LoaiVe, Ngaygiobay, Ngaygioban, NoiBan, GiaVe, Diemdi, Diemden, Lephi;
                while (dr.Read())
                {
                    MaVe = dr.GetString(0);
                    MaHK = dr.GetString(1);
                    ...
                    Diemdi = dr.GetString(8);
                    Diemden = dr.GetString(9);
                    Lephi = dr.GetString(10);
                    Ve v = new Ve (MaVe, MaHK, MaCB, LoaiVe, Ngaygiobay, Ngaygioban, NoiBan, GiaVe, Diemdi, Diemden, Lephi);
                    list.Add(v);
                }
                dr.Close();
            }
